    ...
    <el-container v-loading="isLoading" style="height: 82vh;">
      <el-main style="padding: 5px;">
        <el-table size="medium" ref="scheduleTable" :data="scheduleList" :height="winHeight" style="width: 100%"
          ...
          <el-table-column prop="totalNum" label="检查总数" min-width="100"></el-table-column>
          <el-table-column prop="completeNum" label="完成检查数量" min-width="100">
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getScheduleList() {
      ...
      this.$axios({
        method: 'post',
        url: '/api/v1/device/checkDerivativeTask/list',
        data: {
