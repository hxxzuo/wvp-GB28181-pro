      ...
      <div class="page-header-btn">
        <div v-if="!showTree" style="display: inline;">
          ...
          <el-select size="mini" @change="search" style="width: 8rem; margin-right: 1rem;" v-model="channelType" placeholder="请选择"
            ...
            <el-option label="AIS航标" value="false"></el-option>
            <el-option label="AIS基站" value="true"></el-option>
            <el-option label="AIS中心" value="true"></el-option>
            <el-option label="大型显示灯牌" value="true"></el-option>
            <el-option label="导标" value="true"></el-option>
            <el-option label="灯船" value="true"></el-option>
            <el-option label="灯浮标" value="true"></el-option>
            <el-option label="灯塔" value="true"></el-option>
            <el-option label="灯桩" value="true"></el-option>
            <el-option label="电雾号" value="true"></el-option>
            <el-option label="管线标" value="true"></el-option>
            <el-option label="雷达应答器" value="true"></el-option>
            <el-option label="雷达指向标" value="true"></el-option>
            <el-option label="立标" value="true"></el-option>
            <el-option label="桥梁标志" value="true"></el-option>
          </el-select>
          维护单位:
